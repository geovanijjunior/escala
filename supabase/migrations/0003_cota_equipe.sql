...
create index cotas_equipe_conta_id_idx on cotas_equipe(conta_id);
create index cotas_equipe_unidade_idx on cotas_equipe(unidade_id);
...
create unique index cotas_equipe_geral_uniq
  on cotas_equipe(unidade_id, equipe_id) where dow is null;
create unique index cotas_equipe_dow_uniq
