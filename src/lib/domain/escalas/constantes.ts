...
export const REGRAS_MOTOR: { n: number; titulo: string; desc: string; rigida: boolean }[] = [
  ...
  { n: 7, titulo: 'Capacidade da unidade', desc: 'Nunca aloca acima das posições operacionais (total menos reservadas). Quem não couber vira Trabalho Externo com conflito registrado.', rigida: true },
  { n: 8, titulo: 'Cota semanal de home office', desc: 'A quantidade é rígida; o dia é flexível. Dias proibidos nunca são usados.', rigida: true },
  { n: 9, titulo: 'Distribuição percentual', desc: 'Reparte os dias presenciais entre as unidades pelo método do maior resto, dentro da tolerância configurada.', rigida: false },
  { n: 10, titulo: 'Preferência de home office', desc: 'Tenta usar os dias preferidos antes de qualquer outro dia elegível.', rigida: false },
  { n: 11, titulo: 'Balanceamento e cobertura', desc: 'Evita concentrar a mesma equipe numa unidade e avisa quando a cobertura mínima do dia não é atingida.', rigida: false },
];
